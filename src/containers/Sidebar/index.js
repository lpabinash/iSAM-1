          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "reports" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="reports")
                  })}
                >
                  <NavLink
                     to="/app/reports"
                    onClick={()=>this.changeViewingParentMenu('reports')}
                    data-flag="reports">
                    {/* <i className="iconsmind-Space-Needle" />{" "} */}
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "analytics" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="analytics")
                  })}
                >
                  <NavLink
                     to="/app/analytics"
                    onClick={()=>this.changeViewingParentMenu('analytics')}
                    data-flag="analytics">
                    {/* <i className="iconsmind-Space-Needle" />{" "} */}
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "addNewSite" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="addNewSite")
                  })}
                >
                  <NavLink
                     to="/app/addNewSite"
                    onClick={()=>this.changeViewingParentMenu('addNewSite')}
                    data-flag="addNewSite">
                    {/* <i className="iconsmind-Space-Needle" />{" "} */}
