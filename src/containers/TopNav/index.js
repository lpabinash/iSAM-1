...
class TopNav extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      searchKeyword: "",
      LoginIconDropdownWrapperDisplay: "none",
      LoginIconDropdownDisplay: "none"
    };
  }
  isInFullScreen = () => {
    return (
  ...
  onLoginIconClicked = () => {
    if(this.state.LoginIconDropdownDisplay === "none")
    this.setState({LoginIconDropdownWrapperDisplay: "block", LoginIconDropdownDisplay:"block"});
    else
    this.setState({LoginIconDropdownWrapperDisplay: "none", LoginIconDropdownDisplay:"none"}); 
  }
...
{/* Language Options */}
  ...
  {/* <div className="d-inline-block">
        ...
        <div onClick={this.onLoginIconClicked} class="login-icon">
        ...
        <div style={{display:this.state.LoginIconDropdownWrapperDisplay}} onClick={this.onAnywhereClicked} class="login-icon-dropdownWrapper"><div style={{display: this.state.LoginIconDropdownDisplay}} class="login-icon-dropdown">
          <Link style={{marginLeft: "-1%"}} to="/settings/user" class="dropdown-items">
            <p>My Settings</p>
            <img style={{width:"24px",height:"24px"}} src="https://images.vexels.com/media/users/3/135118/isolated/preview/676bf0e9f3c16649cd7f426c6dcd755a-flat-user-sign-with-round-background-by-vexels.png" />
          </Link>
          <Link style={{marginLeft: "-1%"}} to="/user/2287/profile" class="dropdown-items">
            <p>My Alerts & Schedules</p>
            <i className="fas fa-cogs fa-lg"></i>
          </Link>
          <Link style={{marginLeft: "-1%", marginBottom: "-1%"}} to="/login" class="dropdown-items">
            <p>Logout</p>
